---
description: "Use when editing the BITM330 textbook, rewriting chapters, drafting companion files, revising labs, updating SQL examples, or maintaining book-linked teaching and publishing support files in this repository. Treat the live BITM330 academic course root at G:\\My Drive\\1. Academic\\Teaching\\Albany\\BITM330\\ as the actual course home, separate from the textbook. Trigger phrases: edit my textbook, rewrite this chapter, update this lab, fix this companion file, revise this SQL example, update these lecture notes, prepare this publishing file."
