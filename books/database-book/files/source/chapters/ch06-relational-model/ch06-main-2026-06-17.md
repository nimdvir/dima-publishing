...
<!-- Chapter edit (2026-06-17): converted all 9 legacy :::callout blocks to canonical HTML callout format (call-out skill). design-rule→good-practice or info, takeaway→key-takeaway, warning preserved as warning. Emoji and label updated to canonical legend. No prose changes. -->
---
...
<div class="callout good-practice">
  <p><strong>✅ Good Practice: One table, one subject</strong></p>
  <p>Each table should describe one main subject. A <code>STUDENT</code> table describes students. A <code>DELIVERABLE</code> table describes assignments. A <code>STUDENT_GRADE</code> table connects students to scores. When one table tries to describe everything, no part of it stays clean.</p>
</div>
...
<div class="callout key-takeaway">
  <p><strong>🔑 Key Takeaway: Mixed tables become unreliable</strong></p>
  <p>A flat table looks simple because everything is visible at once. It becomes unreliable because it repeats facts, mixes subjects, and makes ordinary updates dangerous.</p>
</div>
