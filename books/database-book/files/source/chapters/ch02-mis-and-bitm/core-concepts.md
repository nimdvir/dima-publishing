...
*Figure 2.1 — Chapter 2 concept map: foundations of information systems, from data to business performance.*
...
![Moving from data to information, knowledge, and wisdom](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1200/Database-book-BITM330/ch02-mis-and-bitm/ch02-data-iwsom-60)

*Figure 2.9a -- Moving from raw data to information, knowledge, and wisdom.*
...
![Data-to-wisdom hierarchy showing the progression from raw records to actionable judgment](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/Database-book-BITM330/ch02-mis-and-bitm/ch02-data-to-wisdom)

*Figure 2.9b -- The data-to-wisdom hierarchy: from raw records to actionable judgment.*
...
*Figure 2.10 — The R.E.A.D. Framework: Representation and Retrieval, Expression and Experience, Association and Acquisition, Decision-Making and Deployment.*
...
*Figure 2.12 DIKW describes how meaning develops, while R.E.A.D. shows the organizational work that helps move data toward action.*
...
![Slide 5: Data Quality Dimensions](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch02-mis-and-bitm/ch02-data-to-performance-slide-05)
...
*Figure 2.16 — Input-Process-Output Model: Every business transforms inputs into outputs through processes.*
...
*Figure 2.17a — The Data-to-Performance Chain: Data flows into information, insight, decisions, and performance improvement.*
...
*Figure 2.17b — The data-to-wisdom hierarchy: data, information, knowledge, and wisdom build on each other.*
...
*Figure 2.17c — From operational inputs to managerial evidence: data becomes usable information through processing.*
...
*Figure 2.18 — An information system makes information work repeatable: the same event can be recorded, calculated, and reported consistently.*
...
*Figure 2.21 — T.D. Wilson's Information Behavior Model.*
...
*Figure 2.22 — Information behavior links need, seeking, and use; barriers at any stage can prevent information from turning into action.*
...
*Figure 2.19 — Information systems vs. information technology: technology is the tool; the system includes people, data, and processes.*
...
*Figure 2.26 — The Five-Component Framework.*
...
*Figure 2.27 — Information systems work only when hardware, software, data, processes, and people support one another.*
...
![Strategic alignment model connecting business strategy to IT strategy](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/Database-book-BITM330/ch02-mis-and-bitm/ch02-strategic-alignment)

*Figure 2.26a -- Strategic alignment model connecting business strategy to IT strategy.*
...
*Figure 2.29 — Strategic alignment: business strategy and IT strategy must support each other.*
...
![IT governance structure showing decision domains and accountability](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/Database-book-BITM330/ch02-mis-and-bitm/ch02-it-governance)

*Figure 2.27a -- IT governance structure showing decision domains and accountability.*
...
## Application Exercise — Identify an IT Need

Choose one organizational setting — such as student advising, course scheduling, food delivery, retail inventory, hospital intake, or customer service. Then answer the following:

1. What is the **business need** or performance problem?
2. What **data** is involved?
3. How does that data become **information**, **knowledge**, and eventually **action**?
4. What are the relevant **five components of the information system** in this context?
5. How do users **seek, access, interpret, and act on** the information?

![The Data-to-Performance Chain](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch02-mis-and-bitm/ch02-data-to-performance-chain-blueprint)

*Figure 2.31 — The Data-to-Performance Chain.*
...
*Figure 2.30 — Chapter 2 at a glance: foundations of information systems, connecting data, systems, management, and performance.*
...
![Chapter 2 concept map: foundations of information systems from data to business performance](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/Database-book-BITM330/ch02-mis-and-bitm/ch02-summary-map)

*Figure 2.28 -- Chapter 2 concept map: foundations of information systems from data to business performance.*
---
