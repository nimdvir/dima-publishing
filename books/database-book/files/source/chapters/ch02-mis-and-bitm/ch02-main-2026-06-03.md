<!-- Chapter edit: restructured opening to canonical pattern (intro review + infographic + video + objectives → page break → Core Concepts + GIF), resolved author comments, fixed broken text and placeholder captions, renamed duplicate Introduction heading, flagged raw paths for media handoff. Technical meaning preserved. -->
---
...
![Same data can support different organizational timelines and decision levels](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch02-mis-and-bitm/ch02-same-data-different-organizational-timelines)
*Figure 2.20 — The same transaction record can support operational, managerial, and strategic timelines.*
...
*Figure 2.23 — An information system follows the same input-process-output logic as the business processes it supports.*
...
|---|---|---|---|
| 2.2 | Framing the Course Title | Study Questions. | `ch02-study-questions.png` |
| 2.3 | Chapter 2: Foundations of Information Systems | Learning Objectives. | `ch02-learning-objectives.png` |
| 2.4 | Foundations That Carry Forward | Innovation Paradox: Technology value depends on process and organization. | `ch02-innovation-paradox.png` |
| 2.5 | Foundations That Carry Forward | Sweet Spot of Innovation: Intersection of technology, business, and human needs. | `ch02-sweet-spot-innovation.png` |
| 2.6 | Why Foundations Matter | Business activity creates data everywhere, and information systems make those records usable for decisions. | `ch02-interaction-data.png` |
| 2.7 | From Data to Business Meaning | Chapter 2 Infographic Overview. | `ch02-infographic-overview.png` |
| 2.8 | What Is Data? | Data as Raw Material: Data is processed into information, knowledge, and wisdom. | `ch02-data-as-raw-material.png` |
| 2.9 | The DIKW Hierarchy | The DIKW Hierarchy: Moving from data to information, knowledge, and wisdom. | `ch02-data-to-performance-slide-03.png` |
| 2.10 | The DIKW Hierarchy | DIKW Staircase Exam Example. | `ch02-dikw-staircase-exam.png` |
| 2.11 | The R.E.A.D. Framework | DIKW and R.E.A.D. Compared: DIKW describes how meaning develops, while R.E.A.D. shows the organizational work that helps move data toward action. | `ch02-dikw-read-compared.png` |
| 2.12 | The R.E.A.D. Framework | R.E.A.D. online-retailer walkthrough. | `ch02-read-online-retailer-walkthrough.png` |
| 2.13 | Why Data Quality Matters | KPI Before and After Cleaning: Quality data leads to trustworthy metrics. | `ch02-kpi-before-after-cleaning.png` |
| 2.14 | The Input-Process-Output Model | Basic Input-Process-Output Model. | `ch02-image-008.png` |
| 2.15 | Efficiency, Effectiveness, and KPIs | KPI Dashboard Examples. | `ch02-kpi-dashboard-examples.png` |
| 2.16 | Efficiency, Effectiveness, and KPIs | KPI Design Breakdown. | `ch02-kpi-design-breakdown.png` |
| 2.17 | Efficiency, Effectiveness, and KPIs | Efficiency vs Effectiveness 2x2 Matrix. | `ch02-efficiency-vs-effectiveness-matrix.png` |
| 2.18 | The Data-to-Performance Chain | The Data-to-Performance Chain: Performance improves when organizations collect new data, summarize it, choose a response, act, and learn from the results. | `ch02-data-to-performance-chain.png` |
| 2.19 | Management as Decision-Making | Operational, managerial, and strategic decisions each require different kinds of information and different time horizons. | `ch02-organizational-decision-levels.png` |
| 2.20 | Management as Decision-Making | The same transaction record can support operational, managerial, and strategic timelines. | `ch02-same-data-different-organizational-timelines.png` |
| 2.21 | Information Behavior: How People Search for and Use Information | T.D. Wilson's Information Behavior Model. | `ch02-wilson-information-behavior-model.png` |
| 2.22 | Information Behavior: How People Search for and Use Information | Information behavior links need, seeking, and use; barriers at any stage can prevent information from turning into action. | `ch02-information-behavior-workflow.png` |
| 2.23 | What Is an Information System? | An information system follows the same input-process-output logic as the business processes it supports. | `ch02-data-to-performance-slide-06.png` |
| 2.24 | The Five-Component Framework | Information systems work only when hardware, software, data, processes, and people support one another. | `ch02-components.png` |
| 2.25 | Managing Information Systems for Business Value | MIS, BITM, Alignment, and Governance. | `ch02-mis-bitm-alignment-governance.png` |
| 2.26 | Business Information Technology Management (BITM) | MIS focuses on information for decisions, while BITM focuses on managing technology choices in support of business value. | `ch02-mis-vs-bitm-comparison.png` |
| 2.27 | Strategic Alignment | Strategic alignment happens when business goals, organizational design, IT strategy, and IT infrastructure reinforce one another. | `ch02-strategic-alignment-model.png` |
| 2.28 | Governance and Accountability | Governance gives organizations a structure for oversight, accountability, risk management, and technology decision rights. | `ch02-it-governance-structure.png` |
| 2.29 | Foundations That Carry Forward | Foundations Leading into Data Fundamentals. | `ch02-foundations-leading-data-fundamentals.png` |
