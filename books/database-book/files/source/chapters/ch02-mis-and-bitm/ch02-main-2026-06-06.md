...
|---|---|---|---|
| 2.1 | Core Concepts | Chapter 2 concept map: foundations of information systems, from data to business performance. | `ch02-concepts.jpg` |
...
| 2.30 | Chapter Summary | Chapter 2 at a glance: foundations of information systems, connecting data, systems, management, and performance. | `ch02-all.jpg` |
