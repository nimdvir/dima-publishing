...
**22. Select ALL that apply: Which of the following represent correct steps in the chapter's five-step mapping algorithm for translating an ERD into relational tables?**
...
**Question 28: Select ALL that apply: Which structural improvements does the normalized design provide?**
