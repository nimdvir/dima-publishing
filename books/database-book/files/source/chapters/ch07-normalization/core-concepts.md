...
![Dependency diagram for the Grading Database showing four determinants and the attributes they determine, color-coded by table](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch07-normalization/ch07-figure-7.3-fd)
...
![Before-and-after: a multi-valued Grades cell on the left and the same data unpacked into one-row-per-grade on the right](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch07-normalization/ch07-figure-7.5-1nf)

*Figure 7.5 — First Normal Form in action: unpacking a multi-valued cell into atomic, queryable rows.*
...
![Three-panel diagram: a 2NF-violating table split into STUDENT, DELIVERABLE, and STUDENT_GRADE by resolving partial dependencies](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch07-normalization/ch07-figure-7.6-2nf)

*Figure 7.6 — Second Normal Form resolves partial dependencies by moving attributes that depend on only part of the composite key into their own tables.*
...
![Three-layer diagram showing normalized tables at the base, SQL joins and views in the middle, and dashboards and reports at the top](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch07-normalization/ch07-figure-7.9-layers)
...
![Balance scale showing Storage Integrity on one side and Reporting Speed on the other, tilted toward speed](https://res.cloudinary.com/dkndq6lyz/image/upload/f_auto,q_auto,c_limit,w_1600/bitm330book/ch07-normalization/ch07-figure-7.10-scale)
