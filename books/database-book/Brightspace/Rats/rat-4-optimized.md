...
<div style="background: #F0FDFA; border-left: 4px solid #0F766E; padding: 16px 20px; margin: 24px 0; border-radius: 0 6px 6px 0;">
  <p style="margin: 0 0 8px 0; font-size: 1.05em; color: #18181B;">
    ...
    <strong style="color: #0F766E;">Chapter 4: Introduction to Databases</strong>
  ...
  <p style="margin: 0; font-size: 0.95em; color: #18181B;">
    ...
    <a href="https://data-pilot.dimapublishing.com/book/ch04/introduction/1" style="color: #4F46E5; font-weight: 600; text-decoration: none;">
...
*Short description: Database benefits*
...
*Short description: DBMS terminology*
...
*Short description: Data independence*
...
*Short description: Primary keys*
...
*Short description: Foreign keys*
...
*Short description: Constraint types*
...
*Short description: Declarative SQL*

A new analyst writes a SQL query: <code>SELECT CustomerName, COUNT(OrderID) FROM Customers JOIN Orders ON Customers.CustomerID = Orders.CustomerID GROUP BY CustomerName</code>. According to Chapter 4, what makes SQL a "declarative" language?
...
*Short description: Platform choice*
...
*Short description: Spreadsheet limits*
