# RAT 3 — Top Questions (DeepSeek Curation)
...
*Short description: Tests your ability to identify all four types of modification anomalies that can occur in a flat file mixing student and grade themes.*
...
*Short description: Tests your ability to diagnose data quality problems by mapping specific issues to the correct data quality dimensions from Chapter 3.*
...
*Short description: Tests your ability to correctly identify the levels of the data hierarchy from bit through database.*
...
*Short description: Tests your ability to correctly classify data using the NOIR measurement levels, applied to a realistic survey dataset.*
...
*Short description: Tests your understanding of why data type choices have real downstream consequences for analysis.*
...
*Short description: Tests your understanding of NULL semantics and how missing values affect aggregate calculations.*
...
*Short description: Tests your understanding of how shared metadata and data dictionaries prevent definitional conflicts across an organization.*
...
*Short description: Tests your ability to apply data governance concepts — specifically the tension between data access for business use and data protection obligations.*
...
*Short description: Tests your ability to identify the correct data lifecycle stage for data that is no longer actively used but must be preserved.*
...
*Short description: Tests your ability to map a realistic Big Data scenario to the correct V dimension — distinguishing velocity from volume and variety.*
