...
| Book Structure | — | Outline alignment and chapter structure audit | · Replace Ch14 GD main file (currently MS Learn, not Power BI) · Resolve Ch12 draft/source structural drift (BI→OLTP→ETL→DW vs BI→DW→ETL→OLAP) · Import missing companions from GD (Ch15 terms/reflection/rat, Ch13/14 reflection) · Fill in 5 placeholder Terms Treasury files (Ch6, Ch9, Ch11, Ch12, Ch13) · Complete missing RATs (Ch9, Ch10, Ch13) | · Fixed Ch9/Ch10 numbering swap across both repos · Created stub core-concepts.md for ch10, ch13, ch16 · Removed all Figures Index sections from chapters · Created comprehensive outline-2026-06-11.md · Created outline-2026-06-12.md with corrected Ch9/Ch10 titles · Ran full 17-chapter structural audit against outline · Created 9 per-chapter edit files in dima-pub + matching GD .edits files · Updated cross-references, book.yml, registry, image folders · Verified Ch16 main file completeness: 2026-07-20 revised draft covers 16.1–16.20+ (imported, page breaks added, locally deployed) | 2026-07-20 |
| Chapters | 16 | Import revised ch16 main draft, convert separators, local deploy | · Await user confirmation before Vercel production deploy | · Archived previous core-concepts.md → .archive/2026-07-20/ · Replaced 44 --- separators with page breaks · Imported ch16-main-revised-2026-07-20.md (1979 lines, 40 sections) · Generate: 18ch/120sections/317pages/0warnings · Lint passed, build succeeded · Local preview live (localhost:3000) · Documented in ch16-edits.md · Revised commits confirmed on GitHub; production deploy not re-verified during consolidation | 2026-07-20 |
...
| Date       | Ch  | Summary                                                                                                                                                                                                  |
| ---------- | --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-20 | 16  | Imported revised GD draft, converted section separators to page breaks, archived the prior chapter, generated and validated locally, and confirmed the revised commits on GitHub; production deployment not re-verified |
