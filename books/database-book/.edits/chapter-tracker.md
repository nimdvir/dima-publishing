...
| Chapters | 07 | Ch07 editorial pass + images + additions integration | · Create lab companion · Upload slide images to Cloudinary and place in chapter via chapter-media · Decide on appendices (SQL/Access/Review) routing to companions vs main | · Extracted 15 slide images from PPTX · Renamed images with descriptive names · Created ch07-main-2026-06-16.md with YouTube video embed, canonical figure suggestions · Created ch07-images-manifest.md · Updated RAT references to current files · Converted 9 figure suggestions to canonical <!-- Figure Suggestion: --> format | 2026-06-16 |
