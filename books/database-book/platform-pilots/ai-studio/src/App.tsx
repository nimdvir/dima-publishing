...
import { CHAPTERS } from './generated/bookData';
  ...
  return (
    <div className="flex h-screen bg-zinc-100 text-zinc-800 font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-full bg-white relative overflow-hidden">
        ...
        <header className="h-16 border-b border-zinc-200 flex items-center justify-between px-6 bg-white/90 backdrop-blur-md sticky top-0 z-20 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm font-bold text-zinc-800 truncate max-w-[180px] sm:max-w-[400px]">
                {activeChapter.title}
              </span>
            </div>
          </div>
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <div className="flex flex-col items-end">
                  ...
                  <span className={`text-[8px] font-extrabold uppercase px-1.5 py-0.5 mt-1.5 rounded-sm tracking-widest border leading-none ${
                    user.hasPaid 
